...
public class CacheUtils
{
    ...
    private static ShiroRedisCacheManager cacheManager = SpringUtils.getBean(ShiroRedisCacheManager.class);
    ...
    {
        RedisCache<String, Object> cache = cacheManager.getCache(cacheName);
        if (cache == null)
        {
