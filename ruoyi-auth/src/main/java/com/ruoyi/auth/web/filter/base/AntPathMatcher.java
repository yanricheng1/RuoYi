...
import com.ruoyi.auth.web.helper.StringHelper;
...
public class AntPathMatcher implements PatternMatcher {
    ...
    protected boolean doMatch(String pattern, String path, boolean fullMatch) {
        ...
        String[] pattDirs = StringHelper.tokenizeToStringArray(pattern, this.pathSeparator, false, true);
        String[] pathDirs = StringHelper.tokenizeToStringArray(path, this.pathSeparator, false, true);
