    ...
    public String register(SysUser user) {
        ...
        if (ShiroConstants.CAPTCHA_ERROR.equals(ServletUtils.getRequest().getAttribute(ShiroConstants.CURRENT_CAPTCHA))) {
            ...
            if (!regFlag) {
                ...
                LoginInfo loginInfo = LoginInfo.builder().username(loginName).status(Constants.REGISTER)
                        .message(MessageUtils.message("user.register.success")).build();
                BizEventDispatcher.dispatch(BizTopicType.USER_REGISTER, loginInfo);
            }
        }
        return msg;
    }
